...
# NOTE: The Sleep Regularity Index (SRI) formerly lived here as a GGIR-dependent
# stub (SRI_from_GGIR).  It is now implemented from the pipeline's own epoch-level
# SVM data — with no GGIR / R dependency — in sri.py (compute_SRI).
